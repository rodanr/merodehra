...
from advertisement_management.schemas.advertisement import AdvertisementSchema, SearchAdvertisementSchema
...
class PostAdvertisement(Resource):
    ...
    def post(cls):
        ...
        advertisement = AdvertisementModel(advertisement_data['user_id'], advertisement_data['property_type'],
                                           advertisement_data['property_address'], advertisement_data['geo_location'],
                                           advertisement_data['room_count'], advertisement_data['price'],
                                           advertisement_data['description'], advertisement_data['water_source'],
                                           advertisement_data['bathroom'], advertisement_data['terrace_access'], )
