...
class AdvertisementModel(db.Model):
    ...
    def __init__(self, user_id, property_type, property_address, geo_location, room_count, price, description,
                 water_source, bathroom, terrace_access):
    ...
    @classmethod
    def find_by_user_id(cls, user_id: int) -> list:  # List of AdvertisementModel objects
